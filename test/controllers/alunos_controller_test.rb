...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { email: @aluno.email, matricula: @aluno.matricula, nome: @aluno.nome, telefone: @aluno.telefone }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { email: @aluno.email, matricula: @aluno.matricula, nome: @aluno.nome, telefone: @aluno.telefone }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
